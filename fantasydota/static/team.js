...
function cardHtml(p, j, player){
    playerDataCache.set(player.cardId, player);
                            ...
                            p[++j] = '" data-rarity="';
                            p[++j] = player.colour.toLowerCase();
                            p[++j] = '"><div class="card-content"><span class="card-title"><h6><p style="height: 48px;"><span class="playerName left"><strong>';
                            p[++j] = player.name;
                            p[++j] = '</strong></span><span class="teamName right vcenterText">';
                ...
                $.each(data, function(i, player){
                    ...
                    p[++j] = ';" class="card col s9 playerCardSmol rounded bottomRightParent newCard';
                     ...
                     p[++j] = ' rarity-';
                            ...
                            p[++j] = '"><div class="card-content"><span class="card-title"><h6><p style="height: 48px;"><span class="left"><strong>';
                            p[++j] = player.name;
                            p[++j] = '</strong></span><span class="right vcenterText">';
                            p[++j] = '<img class="teamIcon" src="/static/images/dota/teams/';
                            p[++j] = player.limitTypes.team.replace(/[\W_]+/g,"").toLowerCase();
                            p[++j] = '.png"/>';
                            p[++j] = player.limitTypes.team;

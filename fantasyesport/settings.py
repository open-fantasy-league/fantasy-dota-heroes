SOCIAL_AUTH_USER_MODEL = 'fantasyesport.models.User'
SOCIAL_AUTH_LOGIN_FUNCTION = 'fantasyesport.auth.login_user'
SOCIAL_AUTH_LOGGEDIN_FUNCTION = 'fantasyesport.auth.login_required'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    #'fantasyesport.auth.create_user_with_league',

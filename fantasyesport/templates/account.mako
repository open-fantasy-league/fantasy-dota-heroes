...
<div>
    ...
    <p>
    ${"Hi you came 1st for wins/picks/bans. Unfortunately no arcana, however I do have some fall treasure chests for these prizes. please email code 'AdFinemTT' to fantasyesporteu@gmail.com to verify it's you (or just pm me on liquid dota ;) Please provide either steam trade url, or profile link so can add as friend/group to do trade. For trade url go to steam - Trade offers - Who can send me Trade offers" if user.username == "imposer" or user.username == "qoptop" else ""}
    </p>
    <p>
    ${"CONGRATS MR/MRS ARCANA WINNER!!! THANKS FOR PLAYING.  please email code 'AdFinemTT' to fantasyesporteu@gmail.com to verify it's you (or just pm me on liquid dota ;) Please provide either steam trade url, or profile link so can add as friend/group to do trade. For trade url go to steam - Trade offers - Who can send me Trade offers" if user.username == "liquid92" else ""}
    </p>

...
<html lang="${request.locale_name}">
    <head>
        ...
        <link href="${request.static_url('fantasyesport:static/theme.css')}" rel="stylesheet">
        <link href="${request.static_url('fantasyesport:static/favicon.ico')}" rel="icon" type="image/x-icon" />

...
# from fantasyesport.models import TeamHeroLeague, User
...
#
#         transaction.commit()
#     response = urllib2.urlopen("https://www.fantasyesport.eu/tran012345678901234567890looptheloop?state=open")  # open transfer window
#     print response
#
# if __name__ == "__main__":
#     main()

# This no longer useful under new style of no transfers throughout league
...
from fantasyesport.auth import get_user
from fantasyesport.lib.account import check_invalid_password
from fantasyesport.models import User, LeagueUser, League, PasswordReset, LeagueUserDay
...
def forgot_password(request):
    ...
    if not username or not userq:
        ...
        return {"message": "Sorry you did not have an email address associated with this account. Please email fantasyesporteu@gmail.com directly"}
    ...
    try:
        ...
        email_url = "https://www.fantasyesport.eu/resetPasswordPage?u=" + str(userq.id) + "&guid="  # how not hardcode domain bit?
        email_url += quote_plus(guid)
        message = Message(subject="fantasy brood war EU password reset",
                          sender="fantasyesporteu@gmail.com",
